...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ModalProgressHUD( // this shows a loading screen as the user is logging in
        inAsyncCall: loading,
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextField(
                ...
                ) //  with the copywith method we are able to say give me a copy of this const but i want to change something.
              ),
              const SizedBox(
                height: 8.0,
              ),
              ...
              Padding(
                ...
                child: Material(
                  ...
                  child: Rbutton(
                      inputGesture: () async{
                        setState(() {// turn on the loading indicator
                          loading = true;
                        });
                        try {
